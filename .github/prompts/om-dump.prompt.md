...
2. **Search first**: Check if a related note already exists in the vault. Prefer appending to existing notes over creating new ones for small updates.
3. **Create or update** the appropriate note following vault conventions (see `CLAUDE.md`):
