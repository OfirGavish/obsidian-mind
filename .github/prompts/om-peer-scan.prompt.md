---
mode: 'agent'
description: 'Deep scan a peer''s GitHub PRs for performance review preparation. Produces a structured analysis saved to perf/evidence/.'
---
...
Provide name, GitHub username, repo, and optional period in your message.
Example: "Scan Jane Doe (jdoe) in example-repo for Jan 2025 - Jun 2025"
...
3. **Produce structured analysis** with these sections:
   ...
   - **Quality signals** — review comments, change requests, approval patterns, reverts
