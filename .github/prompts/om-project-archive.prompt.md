---
mode: 'agent'
description: 'Move a completed project from work/active/ to work/archive/YYYY/ and update all indexes.'
---
...
Provide the project name in your message after invoking this prompt.
Example: "Archive the Auth Refactor project"
...
**Clustered workstreams**: when the project lives in a topic folder (`work/active/<Topic>/`), move the WHOLE folder:
...
- Check that no wikilinks are broken (Obsidian resolves by name, so moves shouldn't break links)
- Confirm the Work Dashboard Base shows the note in "Completed" view
